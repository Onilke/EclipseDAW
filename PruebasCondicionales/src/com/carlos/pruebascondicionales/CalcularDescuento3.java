...
public class CalcularDescuento3 {
	// constantes
	public static final float PRECIO_LIMITE = 200f; // precio para el descuento
	public static final float DESCUENTO = 0.08f; // porcentaje de descuento
	public static final float DESCUENTO_LIMITE = 200f; // precio limite del descuento
	// programa principal
	...
	public static void main(String[] args) {
		...
		System.out.println("Dame el precio del producto (descuento a partir de 200€)(descuento maximo de 200€):");
		...
		if (entrada.hasNextFloat()) {
			...
			if (precioUsuario >= 0) {
				...
				if (precioUsuario > PRECIO_LIMITE) {
					...
					if (descuentoPrecio > DESCUENTO_LIMITE) {
						descuentoPrecio = DESCUENTO_LIMITE;
						System.out.println("Se te aplicara el descuento maximo de " + DESCUENTO_LIMITE + "€.");
					}
					else {
