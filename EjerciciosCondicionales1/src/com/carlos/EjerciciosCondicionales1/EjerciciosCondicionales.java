		...
		if (entradaDiaAno.hasNextFloat()) {
			...
			if (diaMesAno >= MES_MINIMO && diaMesAno <= MES_MAXIMO) {
				...
				if (diaMesAno == 4) {
					...
					cadena += " de Abril";
					if (diaMes >= 31) {
						System.out.println("Abril no puede tener mas de 30 dias");
						MesAnoConprovar = false;
					}
				}
				if (diaMesAno == 5) {
				...
				if (diaMesAno == 6) {
					...
					cadena += " de Junio";
					if (diaMes >= 31) {
						System.out.println("Junio no puede tener mas de 30 dias");
						MesAnoConprovar = false;
					}
					if (diaMesAno == 7) {
					...
					if (diaMesAno == 9) {
						...
						if (diaMes >= 31) {
							System.out.println("Septiembre no puede tener mas de 30 dias");
							MesAnoConprovar = false;
						}
						if (diaMesAno == 10) {
						...
						if (diaMesAno == 11) {
							...
							cadena += " de Noviembre";
							if (diaMes >= 31) {
								System.out.println("Noviembre no puede tener mas de 30 dias");
								MesAnoConprovar = false;
							}
							if (diaMesAno == 12) {
